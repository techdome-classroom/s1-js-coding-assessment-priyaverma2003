...
console.log(decodeTheRing("aa", "a"));    // Expected output: false
console.log(decodeTheRing("aa", "*"));    // Expected output: true
console.log(decodeTheRing("cb", "?a"));   // Expected output: false
console.log(decodeTheRing("cb", "*b"));